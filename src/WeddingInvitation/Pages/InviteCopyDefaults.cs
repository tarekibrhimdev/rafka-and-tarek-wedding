    ...
    public static Dictionary<string, Dictionary<string, string>> Build(string coupleLine, string? coupleLineAr = null)
    {
        ...
        return new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cin_detail_ceremony_meta"] = "Kherbet Qanafar · West Bekaa",
                ["cin_detail_reception_kicker"] = "Reception",
                ["cin_detail_reception_time"] = "8:00 PM",
                ["cin_detail_reception_venue"] = "Royal Venue",
                ["cin_detail_reception_meta"] = "Kefraya, West Bekaa",

                ["slide2_verse"] =
                    "“What therefore God hath joined together, let not man put asunder.” — Matthew 19:6",

                ["slide2_rsvp"] = "RSVP",
                ["slide2_rsvpPhone1"] = "81 646 800",
                ["slide2_rsvpPhone2"] = "71 675 254",
                ...
                ["cin_location_lead"] = "Ceremony & reception — West Bekaa",
                ...
                ["cin_location_church_meta"] = "Kherbet Qanafar · West Bekaa",
                ["cin_location_venue_kicker"] = "Reception",
                ["cin_location_venue_title"] = "Royal Venue · Kefraya",
                ["cin_location_venue_meta"] = "Western Beqaa · Kefraya · West Bekaa",
                ...
                ["cin_rsvp_label_name"] = "Invitation for",
                ["cin_rsvp_ph_name"] = "",
                ...
                ["cin_gifts_lead"] =
                    "Your presence is gift enough — if you still wish to spoil us, you may use Wish Money (account or phone) or Western Union below.",
                ["cin_gifts_wish_label"] = "Wish Money",
                ["cin_gifts_wish_blurb"] =
                    "You can send using the account number or this phone number — both work for the same Wish wedding account.",
                ["cin_gifts_wish_hint_account"] = "Account number",
                ["cin_gifts_wish_hint_phone"] = "Phone number",
                ["cin_gifts_wish_account"] = "20919566-03",
                ["cin_gifts_phone_display"] = "81 646 800",
                ["cin_gifts_wu_label"] = "Western Union",
                ["cin_gifts_wu_hint"] = "recipient name on the transfer",
            ...
            ["ar"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cin_detail_ceremony_meta"] = "خربة قنافار ، البقاع الغربي",
                ["cin_detail_reception_kicker"] = "الحفل",
                ["cin_detail_reception_time"] = "٨:٠٠ مساءً",
                ["cin_detail_reception_venue"] = "Royal Venue",
                ["cin_detail_reception_meta"] = "كفريا ، البقاع الغربي",
                ...
                ["cin_story_lead"] =
                    "كلُّ الطرقِ قادتنا إلى هنا —\r\nإلى طمأنينةٍ تشبهُ الوطن،\r\nوفرحٍ يكبرُ بنا ومعنا،\r\nوحياةٍ وجد كلٌّ منّا فيها الآخر.",
                ["cin_timeline_2023_caption"] = "أول نظرة",
                ["cin_timeline_2023_body"] = "في ليلةٍ شتويةٍ هادئة، بدأ كلُّ شيءٍ دون أن نُدرك أن العمر سيتغيّر بعدها..",
                ["cin_timeline_2024_caption"] = "أجملُ الأيّام",
                ["cin_timeline_2024_body"] = "كبرت الحكاية بيننا يومًا بعد يوم، وصارت التفاصيل البسيطة أجمل ما نعيشه معًا.",
                ["cin_timeline_2025_caption"] = "الخطوبة",
                ["cin_timeline_2025_body"] = "وفي لحظةٍ تشبه الحلم، وعدنا بعضنا بأن يكون القادم لنا… معًا.",
                ["cin_timeline_2026_caption"] = "الزفاف",
                ["cin_timeline_2026_body"] = "وهنا تبدأ حكايتنا الأجمل —\r\nيومٌ نختار فيه الحبَّ وطنًا،\r\nوالعُمرَ طريقًا واحدًا.",
                ...
                ["cin_location_lead"] = "القداس والحفل — البقاع الغربي",
                ...
                ["cin_location_church_meta"] = "خربة قنافار ، البقاع الغربي",
                ["cin_location_venue_kicker"] = "الحفل",
                ["cin_location_venue_title"] = "رويال فنيو",
                ["cin_location_venue_meta"] = "كفريا ، البقاع الغربي",
                ["cin_maps_open"] = "افتح في الخرائط",
                ["cin_maps_open_aria"] = "افتح هذا المكان في خرائط جوجل",
                ["cin_rsvp_eyebrow"] = "رجاءً الرد",
                ["cin_rsvp_line1"] = "هل تشاركوننا فرحتنا في هذا اليوم المميّز؟",
                ["cin_rsvp_line2"] = "معنا؟",
                ["cin_rsvp_label_name"] = "الدعوة باسم",
                ["cin_rsvp_ph_name"] = "",
                ...
                ["cin_rsvp_success_2"] = "حجزنا لكم مكاناً في قلوبنا في هذا اليوم.",
                ...
                ["cin_gifts_lead"] =
                    "وجودكم معنا هو أجمل هدية،\r\nوإن رغبتم بمشاركتنا فرحتنا بهديةٍ أخرى،\r\nيمكنكم استخدام Wish Money (رقم الحساب أو الهاتف) أو وسترن يونيون أدناه.",
                ["cin_gifts_wish_label"] = "Wish Money",
                ["cin_gifts_wish_blurb"] =
                    "يمكنكم التحويل برقم الحساب أو برقم الهاتف — الخياران يعودان لنفس حساب Wish لحفل الزفاف.",
                ["cin_gifts_wish_hint_account"] = "رقم الحساب",
                ["cin_gifts_wish_hint_phone"] = "رقم الهاتف",
                ["cin_gifts_wish_account"] = "20919566-03",
                ["cin_gifts_phone_display"] = "81 646 800",
                ["cin_gifts_wu_label"] = "وسترن يونيون",
                ["cin_gifts_wu_hint"] = "الاسم كما يظهر على الحوالة",
                ["cin_gifts_wu_name"] = "Tarek Ibrahim",

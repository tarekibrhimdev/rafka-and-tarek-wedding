    ...
    public static Dictionary<string, Dictionary<string, string>> Build(string coupleLine, string? coupleLineAr = null)
    {
        ...
        return new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cin_location_venue_title"] = "Royal Venue · Kafrayya",
                ["cin_location_venue_meta"] = "Western Beqaa · Kafrayya · Lebanon",
                ...
                ["cin_rsvp_label_guests"] = "Guests (including you)",
                ["cin_rsvp_label_party"] = "Who will attend?",
                ["cin_rsvp_party_cap_fmt"] = "Your invitation covers {0} people (including you).",
                ...
                ["cin_gifts_lead"] =
                    "Your presence is gift enough — if you still wish to spoil us, you may use either option below.",
            ...
            ["ar"] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cin_rsvp_label_guests"] = "عدد الضيوف (معك)",
                ["cin_rsvp_label_party"] = "من سيحضر؟",
                ["cin_rsvp_party_cap_fmt"] = "دعوتكم تشمل {0} أشخاص (بمن فيكم).",
                ...
                ["cin_gifts_lead"] =
                    "حضوركم هو أغلى هدية — وإن أردتم تدليلنا، يمكنكم استخدام أحد الخيارين أدناه.",
                ["cin_gifts_wish_label"] = "Wish Money",
